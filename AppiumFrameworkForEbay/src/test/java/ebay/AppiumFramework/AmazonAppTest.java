...
public class AmazonAppTest extends base {
	...
	public void testAmazonAPK() throws IOException, InterruptedException {
		...
		Log.info("Device names are same in Search results page and Product detail page");
		...
		Log.info("Device Prices are same in Search results page and Product detail page");
		...
		Log.info("Device names are same in Product detail page and Cart Page");
		...
		Log.info("Device Prices are same in Product detail page and Cart Page");
